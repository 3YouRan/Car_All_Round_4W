...
uint8_t TX_ADDRESS[TX_ADR_WIDTH]={0xFF,0xFF,0xFF,0xFF,0x02};
uint8_t RX_ADDRESS[RX_ADR_WIDTH]={0xFF,0xFF,0xFF,0xFF,0x02};

uint16_t midValue = 0;
uint8_t NRFHeartBeat = 0;

Control_Struct control_data;
uint8_t Speed_PS_Rece_Buf[32]={0,0,0,0};
